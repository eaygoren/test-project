...
export const SYMBOLS = [
    ...
    { index: 2,  base: "H2",    highlight: "H2_connect", payout: { 3: 25, 4: 50, 5: 100 } },
    { index: 3,  base: "H3",    highlight: "H3_connect", payout: { 3: 25, 4: 50, 5: 100 } },
    { index: 4,  base: "H4",    highlight: "H4_connect", payout: { 3: 25, 4: 50, 5: 100 } },
    { index: 5,  base: "H5",    highlight: "H5_connect", payout: { 3: 25, 4: 50, 5: 100 } },
    { index: 6,  base: "H6",    highlight: "H6_connect", payout: { 3: 10, 4: 25, 5: 100 } },
    { index: 7,  base: "M1",    highlight: "M1_connect", payout: { 3: 10, 4: 25, 5: 75 } },
    { index: 8,  base: "M2",    highlight: "M2_connect", payout: { 3: 10, 4: 25, 5: 75 } },
    { index: 9,  base: "M3",    highlight: "M3_connect", payout: { 3: 10, 4: 25, 5: 75 } },
    { index: 10, base: "M4",    highlight: "M4_connect", payout: { 3: 10, 4: 25, 5: 75 } },
    { index: 11, base: "M5",    highlight: "M5_connect", payout: { 3: 10, 4: 25, 5: 75 } },
    { index: 12, base: "M6",    highlight: "M6_connect", payout: { 3: 10, 4: 25, 5: 75 } },
    { index: 13, base: "9",     highlight: "9_connect",  payout: { 3: 5, 4: 10, 5: 20 } },
    { index: 14, base: "10",    highlight: "10_connect", payout: { 3: 5, 4: 10, 5: 20 } },
    { index: 15, base: "A",     highlight: "A_connect",  payout: { 3: 5, 4: 10, 5: 20 } },
    { index: 16, base: "K",     highlight: "K_connect",  payout: { 3: 5, 4: 10, 5: 20 } },
    { index: 17, base: "Q",     highlight: "Q_connect",  payout: { 3: 5, 4: 10, 5: 20 } },
